import { Briefcase, FolderKanban, NotebookPen, Mail, Target, FileText, Search, Share2, BarChart3 } from "lucide-react";
  ...
  return (
    <footer className="bg-[#0f172a] text-gray-300 py-16 px-6 md:px-20 rounded-4">
      ...
      <div className="grid md:grid-cols-4 gap-10">
        ...
        >
          <h2 className="text-xl font-semibold text-white mb-4">MarketingPro</h2>
        ...
        >
          ...
          <ul className="space-y-3">
            ...
            {[
              { icon: <CiUser />, label: "About Us" },
              { icon: <Briefcase className="w-4 h-4" />, label: "Careers" },
              { icon: <FolderKanban className="w-4 h-4" />, label: "Case Studies" },
              { icon: <NotebookPen className="w-4 h-4" />, label: "Blog" },
